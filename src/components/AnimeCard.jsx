...
export default function AnimeCard({ anime, onToggleWatched, onOpenDetails, onUpdate, onDelete }) {
  ...
  return (
    <motion.div
      ...
      className="bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg shadow overflow-hidden cursor-pointer flex flex-col sm:flex-col md:flex-col"
    ...
    >
      ...
      <div className="p-3 flex flex-col flex-grow">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2">
          ...
          <span className="text-xs text-gray-500 dark:text-gray-400 mt-1 sm:mt-0">{anime.year || '?'}</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between mt-auto gap-2">
          ...
          <div className="flex gap-1 flex-wrap">
            <button
              ...
              className={`px-3 py-1 rounded text-white text-sm ${anime.watched ? 'bg-green-500' : 'bg-gray-500 dark:bg-gray-700'}`}
            >
